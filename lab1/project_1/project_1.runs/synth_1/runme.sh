...
HD_PWD='D:/ICLAB/lab1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_test.tcl
